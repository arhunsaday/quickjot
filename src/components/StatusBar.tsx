...
export function StatusBar({ budget, savedAt, dirty, words, characters, encrypted }: Props) {
  ...
  return (
    <div className="bg-muted/20 flex items-center justify-between gap-3 border-t px-4 py-2.5">
      <div className="flex min-w-0 flex-1 items-center gap-2">
        ...
        />
        <span className="text-muted-foreground truncate text-[11px]" aria-live="polite">
          {saveLabel}
        </span>
        {encrypted && (
          <Tooltip>
      ...
      <span className="text-muted-foreground hidden min-w-0 flex-1 justify-end truncate text-[11px] sm:flex">
