    ...
    <div className="bg-background/80 flex items-center justify-between gap-6 border-t px-4 py-1.5 backdrop-blur">
      ...
      <Tooltip>
        ...
        <TooltipContent className="max-w-[260px]">
          This note's link is {budget.chars.toLocaleString()} characters long.
          Under {PRACTICAL_MAX_CHARS.toLocaleString()} it stays shareable
          through most chat and mail clients.
        </TooltipContent>
      </Tooltip>

      <span className="text-muted-foreground hidden min-w-0 flex-1 justify-end truncate text-xs sm:flex">
