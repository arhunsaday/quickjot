  ...
  return (
    <div className="min-h-dvh">
      ...
      <article className="mx-auto max-w-[760px] px-4 py-20 ">
        ...
        <EditorContent editor={editor} className="qj-document min-h-[65vh]" />

        <hr className="qj-no-print my-10" />
        <p className="text-muted-foreground qj-no-print text-xs">
          Written in QuickJot. This entire note is encoded in the link you
          followed — there is no server holding a copy.
        </p>
      </article>
    </div>
  );
